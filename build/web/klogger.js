(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'klogger'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'klogger'.");
    }
    root.klogger = factory(typeof klogger === 'undefined' ? {} : klogger, kotlin);
  }
  ...
  Object.defineProperty(Logger.prototype, 'isFatalEnabled', {
    get: defineInlineFunction('klogger.com.soywiz.klogger.Logger.get_isFatalEnabled', wrapFunction(function () {
  ...
  Object.defineProperty(Logger.prototype, 'isErrorEnabled', {
    get: defineInlineFunction('klogger.com.soywiz.klogger.Logger.get_isErrorEnabled', wrapFunction(function () {
      var Logger$Level = _.com.soywiz.klogger.Logger.Level;
      return function () {
  ...
  Object.defineProperty(Logger.prototype, 'isWarnEnabled', {
    get: defineInlineFunction('klogger.com.soywiz.klogger.Logger.get_isWarnEnabled', wrapFunction(function () {
      var Logger$Level = _.com.soywiz.klogger.Logger.Level;
      return function () {
  ...
  Object.defineProperty(Logger.prototype, 'isInfoEnabled', {
    get: defineInlineFunction('klogger.com.soywiz.klogger.Logger.get_isInfoEnabled', wrapFunction(function () {
      var Logger$Level = _.com.soywiz.klogger.Logger.Level;
      return function () {
  ...
  Object.defineProperty(Logger.prototype, 'isDebugEnabled', {
    get: defineInlineFunction('klogger.com.soywiz.klogger.Logger.get_isDebugEnabled', wrapFunction(function () {
      var Logger$Level = _.com.soywiz.klogger.Logger.Level;
      return function () {
  ...
  Object.defineProperty(Logger.prototype, 'isTraceEnabled', {
    get: defineInlineFunction('klogger.com.soywiz.klogger.Logger.get_isTraceEnabled', wrapFunction(function () {
      var Logger$Level = _.com.soywiz.klogger.Logger.Level;
      return function () {
  ...
  Logger.prototype.log_ky4efp$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.log_ky4efp$', wrapFunction(function () {
    return function (level, msg) {
      if (this.isEnabled_fs4ikx$(level))
        this.actualLog_pwm3k3$(level, msg());
    };
  }));
  Logger.prototype.fatal_nq59yw$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.fatal_nq59yw$', wrapFunction(function () {
    var Logger$Level = _.com.soywiz.klogger.Logger.Level;
    return function (msg) {
  ...
  Logger.prototype.error_nq59yw$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.error_nq59yw$', wrapFunction(function () {
    var Logger$Level = _.com.soywiz.klogger.Logger.Level;
    return function (msg) {
  ...
  Logger.prototype.warn_nq59yw$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.warn_nq59yw$', wrapFunction(function () {
    var Logger$Level = _.com.soywiz.klogger.Logger.Level;
    return function (msg) {
  ...
  Logger.prototype.info_nq59yw$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.info_nq59yw$', wrapFunction(function () {
    var Logger$Level = _.com.soywiz.klogger.Logger.Level;
    return function (msg) {
  ...
  Logger.prototype.debug_nq59yw$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.debug_nq59yw$', wrapFunction(function () {
    var Logger$Level = _.com.soywiz.klogger.Logger.Level;
    return function (msg) {
  ...
  Logger.prototype.trace_nq59yw$ = defineInlineFunction('klogger.com.soywiz.klogger.Logger.trace_nq59yw$', wrapFunction(function () {
    var Logger$Level = _.com.soywiz.klogger.Logger.Level;
    return function (msg) {
  ...
  var KLOGGER_VERSION;
  var error = defineInlineFunction('klogger.com.soywiz.klogger.error_38edjy$', function ($receiver, msg) {
    var tmp$;
    (tmp$ = console).error.apply(tmp$, msg);
  });
  var log = defineInlineFunction('klogger.com.soywiz.klogger.log_38edjy$', function ($receiver, msg) {
    var tmp$;
  ...
  KLOGGER_VERSION = '1.6.0';
  isNative = false;
  Kotlin.defineModule('klogger', _);
  return _;
}));

//# sourceMappingURL=klogger.js.map

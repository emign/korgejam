(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'korma', 'kmem', 'korio', 'kds', 'klock', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('korma'), require('kmem'), require('korio'), require('kds'), require('klock'), require('kotlinx-coroutines-core'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'korim'.");
    }
    if (typeof korma === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'korma' was not found. Please, check whether 'korma' is loaded prior to 'korim'.");
    }
    if (typeof kmem === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'kmem' was not found. Please, check whether 'kmem' is loaded prior to 'korim'.");
    }
    if (typeof korio === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'korio' was not found. Please, check whether 'korio' is loaded prior to 'korim'.");
    }
    if (typeof kds === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'kds' was not found. Please, check whether 'kds' is loaded prior to 'korim'.");
    }
    if (typeof klock === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'klock' was not found. Please, check whether 'klock' is loaded prior to 'korim'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'korim'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'korim'.");
    }
    root.korim = factory(typeof korim === 'undefined' ? {} : korim, kotlin, korma, kmem, korio, kds, klock, this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$korma, $module$kmem, $module$korio, $module$kds, $module$klock, $module$kotlinx_coroutines_core) {
  'use strict';
  var $$importsForInline$$ = _.$$importsForInline$$ || (_.$$importsForInline$$ = {});
  var Kind_OBJECT = Kotlin.Kind.OBJECT;
  var toIntFloor = $module$kmem.com.soywiz.kmem.toIntFloor_yrwdxr$;
  var toIntCeil = $module$kmem.com.soywiz.kmem.toIntCeil_yrwdxr$;
  ...
  var Sizeable = $module$korma.com.soywiz.korma.geom.Sizeable;
  var throwCCE = Kotlin.throwCCE;
  var divCeil = $module$kmem.com.soywiz.kmem.divCeil_dqglrj$;
  ...
  var RectangleInt = $module$korma.com.soywiz.korma.geom.RectangleInt;
  var Iterable = Kotlin.kotlin.collections.Iterable;
  var Enum = Kotlin.kotlin.Enum;
  var throwISE = Kotlin.throwISE;
  var lang = $module$korio.com.soywiz.korio.lang;
  var insert = $module$kmem.com.soywiz.kmem.insert_4684dr$;
  ...
  var getCyclic = $module$kds.com.soywiz.kds.getCyclic_r20n03$;
  var toBase64 = $module$korio.com.soywiz.korio.util.encoding.toBase64_964n91$;
  ...
  var Throwable = Error;
  var get_length = $module$korio.com.soywiz.korio.util.get_length_9tsm8a$;
  var clamp_0 = $module$kmem.com.soywiz.kmem.clamp_nig4hr$;
  var sum = Kotlin.kotlin.collections.sum_plj8ka$;
  var get_endExclusive = $module$korio.com.soywiz.korio.util.get_endExclusive_9tsm8a$;
  ...
  var extract8 = $module$kmem.com.soywiz.kmem.extract8_dqglrj$;
  var extractScaledFF = $module$kmem.com.soywiz.kmem.extractScaledFF_e4yvb3$;
  var extractScaledFFDefault = $module$kmem.com.soywiz.kmem.extractScaledFFDefault_4684dr$;
  var insertScaledFF = $module$kmem.com.soywiz.kmem.insertScaledFF_4684dr$;
  var readU16LE = $module$kmem.com.soywiz.kmem.readU16LE_mrm5p$;
  var getCallableRef = Kotlin.getCallableRef;
  var readU16BE = $module$kmem.com.soywiz.kmem.readU16BE_mrm5p$;
  var readU24LE = $module$kmem.com.soywiz.kmem.readU24LE_mrm5p$;
  var readU24BE = $module$kmem.com.soywiz.kmem.readU24BE_mrm5p$;
  var readS32LE = $module$kmem.com.soywiz.kmem.readS32LE_mrm5p$;
  var readS32BE = $module$kmem.com.soywiz.kmem.readS32BE_mrm5p$;
  var write16LE = $module$kmem.com.soywiz.kmem.write16LE_ietg8x$;
  var write16BE = $module$kmem.com.soywiz.kmem.write16BE_ietg8x$;
  var write24LE = $module$kmem.com.soywiz.kmem.write24LE_ietg8x$;
  var write24BE = $module$kmem.com.soywiz.kmem.write24BE_ietg8x$;
  var write32LE = $module$kmem.com.soywiz.kmem.write32LE_ietg8x$;
  var write32BE = $module$kmem.com.soywiz.kmem.write32BE_ietg8x$;
  var interpolate = $module$korma.com.soywiz.korma.interpolation.interpolate_nig4hr$;
  var interpolate_0 = $module$korma.com.soywiz.korma.interpolation.interpolate_i767ff$;
  var get_niceStr = $module$korio.com.soywiz.korio.util.get_niceStr_yrwdxr$;
  var MutableInterpolable = $module$korma.com.soywiz.korma.interpolation.MutableInterpolable;
  var Interpolable = $module$korma.com.soywiz.korma.interpolation.Interpolable;
  var substr = $module$korio.com.soywiz.korio.lang.substr_6ic1pp$;
  var setOf = Kotlin.kotlin.collections.setOf_i5x0yv$;
  var substr_0 = $module$korio.com.soywiz.korio.lang.substr_qgyqat$;
  ...
  var insert8 = $module$kmem.com.soywiz.kmem.insert8_e4yvb3$;
  ...
  var GenericSubList = $module$kds.com.soywiz.kds.GenericSubList;
  ...
  var GenericListIterator = $module$kds.com.soywiz.kds.GenericListIterator;
  var List = Kotlin.kotlin.collections.List;
  var get_niceStr_0 = $module$korio.com.soywiz.korio.util.get_niceStr_81szk$;
  ...
  var unquote = $module$korio.com.soywiz.korio.util.unquote_pdl1vz$;
  var first = Kotlin.kotlin.collections.first_7wnvza$;
  var toMap = Kotlin.kotlin.collections.toMap_6hr0sd$;
  var toIntMap = $module$kds.com.soywiz.kds.toIntMap_hx7udi$;
  var Xml = $module$korio.com.soywiz.korio.serialization.xml.Xml_61zpoe$;
  var firstOrNull = Kotlin.kotlin.collections.firstOrNull_7wnvza$;
  var get_0 = $module$korio.com.soywiz.korio.serialization.xml.get_h00kq4$;
  var get_indices = Kotlin.kotlin.text.get_indices_gw00vp$;
  var toChar = Kotlin.toChar;
  var String_fromIntArray = $module$korio.com.soywiz.korio.lang.String_fromIntArray_nd5v6f$;
  var IntMap_init = $module$kds.com.soywiz.kds.IntMap_init_42wstk$;
  var CharRange = Kotlin.kotlin.ranges.CharRange;
  var readS16LE = $module$korio.com.soywiz.korio.stream.readS16LE_p2awyq$;
  var sliceStart = $module$korio.com.soywiz.korio.stream.sliceStart_gezhyr$;
  var readU16BE_0 = $module$korio.com.soywiz.korio.stream.readU16BE_p2awyq$;
  var readStringz = $module$korio.com.soywiz.korio.stream.readStringz_6ey4ts$;
  var readS32BE_0 = $module$korio.com.soywiz.korio.stream.readS32BE_p2awyq$;
  var sliceWithSize = $module$korio.com.soywiz.korio.stream.sliceWithSize_acdave$;
  var sliceWithSize_0 = $module$korio.com.soywiz.korio.stream.sliceWithSize_1r8368$;
  var readAll = $module$korio.com.soywiz.korio.stream.readAll_ucmi9i$;
  var toString = $module$korio.com.soywiz.korio.lang.toString_5kit73$;
  var readBytesExact = $module$korio.com.soywiz.korio.stream.readBytesExact_xpzb7k$;
  var FastByteArrayInputStream = $module$korio.com.soywiz.korio.stream.FastByteArrayInputStream;
  var get_hex = $module$korio.com.soywiz.korio.util.encoding.get_hex_s8ev3n$;
  var readS64BE = $module$korio.com.soywiz.korio.stream.readS64BE_p2awyq$;
  var L1000 = Kotlin.Long.fromInt(1000);
  var readS16BE = $module$korio.com.soywiz.korio.stream.readS16BE_p2awyq$;
  var last = Kotlin.kotlin.collections.last_2p1efm$;
  var readCharArrayBE = $module$korio.com.soywiz.korio.stream.readCharArrayBE_xpzb7k$;
  var readShortArrayBE = $module$korio.com.soywiz.korio.stream.readShortArrayBE_xpzb7k$;
  var getOrNull = Kotlin.kotlin.collections.getOrNull_c03ot6$;
  var L0 = Kotlin.Long.ZERO;
  var readS8 = $module$korio.com.soywiz.korio.stream.readS8_p2awyq$;
  var readU8 = $module$korio.com.soywiz.korio.stream.readU8_p2awyq$;
  ...
  var readS32LE_0 = $module$korio.com.soywiz.korio.stream.readS32LE_p2awyq$;
  var readBytes = $module$korio.com.soywiz.korio.stream.readBytes_xpzb7k$;
  var listOf_0 = Kotlin.kotlin.collections.listOf_mh5how$;
  var skip = $module$korio.com.soywiz.korio.stream.skip_hsu5ns$;
  var write8 = $module$korio.com.soywiz.korio.stream.write8_n5df9z$;
  var write32LE_0 = $module$korio.com.soywiz.korio.stream.write32LE_n5df9z$;
  var write16LE_0 = $module$korio.com.soywiz.korio.stream.write16LE_n5df9z$;
  var writeBytes = $module$korio.com.soywiz.korio.stream.writeBytes_o1e1if$;
  var readString = $module$korio.com.soywiz.korio.stream.readString_6ey4ts$;
  var readStream = $module$korio.com.soywiz.korio.stream.readStream_hsu5ns$;
  var readIntArrayLE = $module$korio.com.soywiz.korio.stream.readIntArrayLE_xpzb7k$;
  var openSync = $module$korio.com.soywiz.korio.stream.openSync_m1iwyb$;
  var Extra$Property = $module$kds.com.soywiz.kds.Extra.Property;
  var readU32LE = $module$kmem.com.soywiz.kmem.readU32LE_mrm5p$;
  ...
  var readU8_0 = $module$kmem.com.soywiz.kmem.readU8_mrm5p$;
  var readU16LE_0 = $module$korio.com.soywiz.korio.stream.readU16LE_p2awyq$;
  var readU32BE = $module$korio.com.soywiz.korio.stream.readU32BE_p2awyq$;
  ...
  var toByteArray = $module$korio.com.soywiz.korio.stream.toByteArray_ucmi9i$;
  ...
  var get_hex_0 = $module$korio.com.soywiz.korio.util.encoding.get_hex_964n91$;
  var toList = Kotlin.kotlin.collections.toList_7wnvza$;
  var toList_0 = Kotlin.kotlin.collections.toList_us0mfu$;
  var toString_0 = Kotlin.toString;
  var readAll_0 = $module$korio.com.soywiz.korio.stream.readAll_yjldv$;
  var println = Kotlin.kotlin.io.println_s8jyv4$;
  var write32BE_0 = $module$korio.com.soywiz.korio.stream.write32BE_n5df9z$;
  var toByteArray_0 = $module$korio.com.soywiz.korio.lang.toByteArray_7jlb4b$;
  var copyOf_0 = Kotlin.kotlin.collections.copyOf_mrm5p$;
  var checksum = $module$korio.com.soywiz.korio.util.checksum;
  var convertRangeClamped = $module$kmem.com.soywiz.kmem.convertRangeClamped_legt9$;
  var ZLib = $module$korio.com.soywiz.korio.compression.deflate.ZLib;
  var CompressionContext = $module$korio.com.soywiz.korio.compression.CompressionContext;
  var compress = $module$korio.com.soywiz.korio.compression.compress_t54tj5$;
  var write8_0 = $module$kmem.com.soywiz.kmem.write8_ietg8x$;
  var ByteArrayBuilder_init = $module$kmem.com.soywiz.kmem.ByteArrayBuilder_init_za3lpa$;
  var UByteArrayInt_0 = $module$kmem.com.soywiz.kmem.UByteArrayInt_za3lpa$;
  var readStream_0 = $module$korio.com.soywiz.korio.stream.readStream_gezhyr$;
  var asByteArray = $module$kmem.com.soywiz.kmem.asByteArray_ngdjuy$;
  var get_eof = $module$korio.com.soywiz.korio.stream.get_eof_ucmi9i$;
  var uncompress = $module$korio.com.soywiz.korio.compression.uncompress_ms6xh0$;
  var extract = $module$kmem.com.soywiz.kmem.extract_e4yvb3$;
  var readAvailable = $module$korio.com.soywiz.korio.stream.readAvailable_ucmi9i$;
  var openFastStream = $module$korio.com.soywiz.korio.stream.openFastStream_mrm5p$;
  ...
  var clamp01 = $module$kmem.com.soywiz.kmem.clamp01_81szk$;
  var transformed = $module$korma.com.soywiz.korma.geom.transformed_4z5n62$;
  var bounds = $module$korma.com.soywiz.korma.geom.bounds_9zueiu$;
  var toPathList = $module$korma.com.soywiz.korma.geom.shape.toPathList_jvwkvo$;
  var toPoints = $module$korma.com.soywiz.korma.geom.toPoints_qj0m41$;
  var first_0 = Kotlin.kotlin.collections.first_2p1efm$;
  var Matrix = $module$korma.com.soywiz.korma.geom.Matrix;
  var distanceTo = $module$korma.com.soywiz.korma.geom.distanceTo_5jbsoh$;
  var Angle = $module$korma.com.soywiz.korma.geom.Angle;
  var transformX = $module$korma.com.soywiz.korma.geom.transformX_ccqrid$;
  var clamp01_0 = $module$kmem.com.soywiz.kmem.clamp01_yrwdxr$;
  var rect = $module$korma.com.soywiz.korma.geom.vector.rect_clsz36$;
  var roundRect = $module$korma.com.soywiz.korma.geom.vector.roundRect_eslsqu$;
  var Rectangle = $module$korma.com.soywiz.korma.geom.Rectangle;
  var transformY = $module$korma.com.soywiz.korma.geom.transformY_ccqrid$;
  ...
  var Stack = $module$kds.com.soywiz.kds.Stack;
  var getPropertyCallableRef = Kotlin.getPropertyCallableRef;
  var Disposable = $module$korio.com.soywiz.korio.lang.Disposable;
  var VectorBuilder = $module$korma.com.soywiz.korma.geom.vector.VectorBuilder;
  var numberToDouble = Kotlin.numberToDouble;
  var VectorPath$Winding = $module$korma.com.soywiz.korma.geom.vector.VectorPath.Winding;
  var VectorPath = $module$korma.com.soywiz.korma.geom.vector.VectorPath;
  var Xml_0 = $module$korio.com.soywiz.korio.serialization.xml.Xml;
  var linkedMapOf = Kotlin.kotlin.collections.linkedMapOf_qfcya0$;
  var mapOf_0 = Kotlin.kotlin.collections.mapOf_x2b85n$;
  var toStringDecimal = $module$korio.com.soywiz.korio.util.toStringDecimal_9rbwic$;
  var BoundsBuilder = $module$korma.com.soywiz.korma.geom.BoundsBuilder;
  var add = $module$korma.com.soywiz.korma.geom.vector.add_1ik72i$;
  var plus_1 = Kotlin.kotlin.collections.plus_iwxh38$;
  var add_0 = $module$korma.com.soywiz.korma.geom.add_wm3ouy$;
  ...
  var get_allChildren = $module$korio.com.soywiz.korio.serialization.xml.get_allChildren_ibjdnu$;
  var get_isComment = $module$korio.com.soywiz.korio.serialization.xml.get_isComment_byavcz$;
  var circle = $module$korma.com.soywiz.korma.geom.vector.circle_m5r0a8$;
  var StrReader = $module$korio.com.soywiz.korio.util.StrReader;
  var get_isNumeric = $module$korio.com.soywiz.korio.util.get_isNumeric_myv2d0$;
  var ListReader = $module$kds.com.soywiz.kds.ListReader;
  var isDigit = $module$korio.com.soywiz.korio.util.isDigit_myv2d0$;
  var isLetterOrUnderscore = $module$korio.com.soywiz.korio.util.isLetterOrUnderscore_myv2d0$;
  var expect = $module$kds.com.soywiz.kds.expect_2mact2$;
  ...
  var isEmpty = $module$korma.com.soywiz.korma.geom.vector.isEmpty_6jcdf2$;
  ...
  Bitmap.prototype.forEach_50fifn$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.Bitmap.forEach_50fifn$', function (sx, sy, width, height, callback) {
    if (sx === void 0)
      sx = 0;
    if (sy === void 0)
      sy = 0;
  ...
  var context2d = defineInlineFunction('korim.com.soywiz.korim.bitmap.context2d_rr3dot$', function ($receiver, antialiased, callback) {
  ...
  Bitmap32.prototype.copy_akhah0$ = function (srcX, srcY, dst, dstX, dstY, width, height) {
    ...
    for (var y = 0; y < height; y++) {
      var srcPos = srcIndex;
      arrayCopy(srcArray.ints, dstArray.ints, dstIndex, srcPos, srcPos + width | 0);
      srcIndex = srcIndex + srcAdd | 0;
      dstIndex = dstIndex + dstAdd | 0;
    }
  };
  ...
  Bitmap32.prototype._draw_dd24ng$ = function (src, dx, dy, sleft, stop, sright, sbottom, mix) {
    ...
    for (var y = 0; y < height; y++) {
      ...
      if (mix) {
        for (var x = 0; x < width; x++)
          dstData.set_vlvk8p$(dstOffset + x | 0, dstData.get_za3lpa$(dstOffset + x | 0).mix_md34sx$(srcData.get_za3lpa$(srcOffset + x | 0)));
      }
       else {
  ...
  Bitmap32.prototype.all_vcmugg$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.Bitmap32.all_vcmugg$', wrapFunction(function () {
    var until = Kotlin.kotlin.ranges.until_dqglrj$;
  ...
  Bitmap32.prototype.setEach_xn9fzl$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.Bitmap32.setEach_xn9fzl$', wrapFunction(function () {
    return function (sx, sy, width, height, callback) {
      if (sx === void 0)
        sx = 0;
      if (sy === void 0)
        sy = 0;
  ...
  Bitmap32.prototype.updateColors_nwnvpc$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.Bitmap32.updateColors_nwnvpc$', wrapFunction(function () {
    return function (sx, sy, width, height, callback) {
      if (sx === void 0)
        sx = 0;
      if (sy === void 0)
  ...
  Bitmap32.prototype.updateColorsXY_covpbs$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.Bitmap32.updateColorsXY_covpbs$', wrapFunction(function () {
    return function (sx, sy, width, height, callback) {
      if (sx === void 0)
        sx = 0;
      if (sy === void 0)
  ...
  var Bitmap32$updateColors$lambda = wrapFunction(function () {
    return function (closure$callback, this$Bitmap32) {
      return function (n, x, y) {
        this$Bitmap32.data.set_vlvk8p$(n, closure$callback(this$Bitmap32.data.get_za3lpa$(n)));
        return Unit;
      };
    };
  });
  ...
  var Bitmap32$setEach$lambda = wrapFunction(function () {
    return function (closure$callback, this$Bitmap32) {
      return function (n, x, y) {
        this$Bitmap32.data.set_vlvk8p$(n, closure$callback(x, y));
        return Unit;
      };
    };
  });
  Bitmap32.prototype.scaleNearest_vux9f0$ = function (sx, sy) {
    var $receiver = new Bitmap32(Kotlin.imul(this.width, sx), Kotlin.imul(this.height, sy));
    var width;
    width = $receiver.width - 0 | 0;
    var tmp$, tmp$_0, tmp$_1;
    tmp$ = 0 + ($receiver.height - 0 | 0) | 0;
    for (var y = 0; y < tmp$; y++) {
      var n = $receiver.index_vux9f0$(0, 0 + y | 0);
      tmp$_0 = 0 + width | 0;
      for (var x = 0; x < tmp$_0; x++) {
        $receiver.data.set_vlvk8p$((tmp$_1 = n, n = tmp$_1 + 1 | 0, tmp$_1), this.get_vux9f0$(x / sx | 0, y / sy | 0));
      }
    }
    return $receiver;
  };
  Bitmap32.prototype.scaleLinear_lu1900$ = function (sx, sy) {
    var $receiver = new Bitmap32(numberToInt(this.width * sx), numberToInt(this.height * sy));
    var width;
    width = $receiver.width - 0 | 0;
    var tmp$, tmp$_0, tmp$_1;
    tmp$ = 0 + ($receiver.height - 0 | 0) | 0;
    for (var y = 0; y < tmp$; y++) {
      ...
      tmp$_0 = 0 + width | 0;
      for (var x = 0; x < tmp$_0; x++) {
        $receiver.data.set_vlvk8p$((tmp$_1 = n, n = tmp$_1 + 1 | 0, tmp$_1), this.getRgbaSampled_lu1900$(x / sx, y / sy));
      }
    }
    return $receiver;
  };
  ...
  BitmapIndexed.prototype.get_vux9f0$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.BitmapIndexed.get_vux9f0$', function (x, y) {
    return this.getInt_vux9f0$(x, y);
  });
  BitmapIndexed.prototype.set_qt1dr2$ = defineInlineFunction('korim.com.soywiz.korim.bitmap.BitmapIndexed.set_qt1dr2$', function (x, y, color) {
    this.setInt_qt1dr2$(x, y, color);
  });
  ...
  var decodeInternal = defineInlineFunction('korim.com.soywiz.korim.color.decodeInternal_4v8vnc$', wrapFunction(function () {
  ...
  var ColorTransform_0 = defineInlineFunction('korim.com.soywiz.korim.color.ColorTransform_d3e2w0$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var numberToInt = Kotlin.numberToInt;
  ...
  var ColorTransform_1 = defineInlineFunction('korim.com.soywiz.korim.color.ColorTransform_6tck58$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var numberToInt = Kotlin.numberToInt;
    var ColorTransform_init = _.com.soywiz.korim.color.ColorTransform;
  ...
  RGBA.prototype.withA_za3lpa$ = function (v) {
    return new RGBA(this.value & 16777215 | (v & 255) << 16);
  };
  ...
  RGBA$Companion.prototype.mix_jh0t86$ = function (dst, src) {
    ...
    switch (srcA) {
      ...
      case 255:
        tmp$ = src;
        break;
      default:tmp$ = RGBA$Companion_getInstance().invoke_vux9f0$(this.mixRgbFactor256_74wf1k$(dst, src, srcA + 1 | 0).rgb, dst.a + srcA | 0);
        break;
    }
    return tmp$;
  };
  ...
  Object.defineProperty(RGBAPremultiplied.prototype, 'depremultiplied', {
    get: function () {
      var A = this.value >>> 24;
      var A1 = A + 1 | 0;
      var R = (((this.value >>> 0 & 255) << 8) / A1 | 0) & 255;
      var G = (((this.value >>> 8 & 255) << 8) / A1 | 0) & 255;
      var B = (((this.value >>> 16 & 255) << 8) / A1 | 0) & 255;
      return RGBA$Companion_getInstance().invoke_tjonv8$(R, G, B, A);
    }
  });
  ...
  RgbaPremultipliedArray.prototype.fill_600akl$ = function (value, start, end) {
    ...
    var $receiver = this.ints;
    var value_0 = value.value;
  ...
  function mix($receiver, other, ratio) {
  ...
  var RGBAf_0 = defineInlineFunction('korim.com.soywiz.korim.color.RGBAf_1ugm5o$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
  ...
  var KDynamic = $module$korio.com.soywiz.korio.dynamic.KDynamic;
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            var tmp$_11;
            var line = trim_0(Kotlin.isCharSequence(tmp$_11 = rline) ? tmp$_11 : throwCCE()).toString();
  ...
  var TimedResult_init = $module$klock.com.soywiz.klock.TimedResult;
  ...
  TtfFont.prototype.runTableUnit_efgvrk$ = defineInlineFunction('korim.com.soywiz.korim.font.ttf.TtfFont.runTableUnit_efgvrk$', function (name, callback) {
    var tmp$;
    (tmp$ = this.openTable_61zpoe$(name)) != null ? callback(tmp$) : null;
  });
  TtfFont.prototype.runTable_w0e0qj$ = defineInlineFunction('korim.com.soywiz.korim.font.ttf.TtfFont.runTable_w0e0qj$', wrapFunction(function () {
  ...
  var setExtra = $module$kds.com.soywiz.kds.setExtra_46skc7$;
  ...
  function ImageFormat(exts) {
    ...
    for (tmp$ = 0; tmp$ !== exts.length; ++tmp$) {
      ...
      var tmp$_1;
      tmp$_0.call(destination, trim_0(Kotlin.isCharSequence(tmp$_1 = $receiver) ? tmp$_1 : throwCCE()).toString());
    }
  ...
  var ByteArrayBuilder_init_0 = $module$korio.$$importsForInline$$.kmem.com.soywiz.kmem.ByteArrayBuilder_init_za3lpa$;
  ...
  ImageFormat.prototype.encode_dqmhj5$ = function (frames, props) {
    if (props === void 0)
      props = new ImageEncodingProps('unknown');
    var buffer = ByteArrayBuilder_init_0(get_area(frames) * 4 | 0);
  ...
  ImageFormat.prototype.encode_ruzdkj$ = function (image, props) {
    if (props === void 0)
      props = new ImageEncodingProps('unknown');
    var buffer = ByteArrayBuilder_init_0(image.area * 4 | 0);
    var s = MemorySyncStream_0(buffer);
  ...
  defineInlineFunction('korim.com.soywiz.korim.format.disableNativeImageLoading_o14v8n$', wrapFunction(function () {
  ...
  function PNG$writeImage$writeChunk_0(closure$writeChunk) {
    return function (name, initialCapacity, callback) {
      ...
      var buffer = ByteArrayBuilder_init_0(initialCapacity);
      var s = MemorySyncStream_0(buffer);
      callback(s);
      ...
      for (var row = tmp$_5; row < height; row += tmp$_6) {
        ...
        if (bmp8 != null) {
          ...
          switch (header.bitsPerChannel) {
            case 1:
              for (var n = 0; n < width; n++) {
                bmp.setInt_qt1dr2$(col + n | 0, row, extract(currentRow.get_za3lpa$(n / 8 | 0), n % 8 * 1 | 0, 1));
              }

              break;
            case 2:
              for (var n_0 = 0; n_0 < width; n_0++) {
                bmp.setInt_qt1dr2$(col + n_0 | 0, row, extract(currentRow.get_za3lpa$(n_0 / 4 | 0), n_0 % 4 * 2 | 0, 2));
              }

              break;
            case 4:
              for (var n_1 = 0; n_1 < width; n_1++) {
                bmp.setInt_qt1dr2$(col + n_1 | 0, row, extract(currentRow.get_za3lpa$(n_1 / 2 | 0), n_1 % 2 * 4 | 0, 4));
              }
  ...
  RegisteredImageFormats.prototype.temporalRegister_t3vfgu$ = defineInlineFunction('korim.com.soywiz.korim.format.RegisteredImageFormats.temporalRegister_t3vfgu$', function (formats, callback) {
  ...
  var RedirectMutableFieldGen_init = $module$korio.com.soywiz.korio.util.RedirectMutableFieldGen;
  ...
  Context2d.prototype.buffering_klfg04$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.buffering_klfg04$', function (callback) {
    this.renderer.bufferingStart();
    try {
      return callback();
    }
    finally {
  ...
  Context2d$Renderer.prototype.buffering_klfg04$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.Renderer.buffering_klfg04$', function (callback) {
    this.bufferingStart();
    try {
      return callback();
    }
  ...
  Context2d$Renderer.prototype.drawImage_dfapkx$$default = function (image, x, y, width, height, transform) {
    ...
    var state = new Context2d$State(transform, tmp$, $receiver, void 0, void 0, void 0, void 0, void 0, void 0, new Context2d$BitmapPaint(image, (new Matrix()).scale_lu1900$(width / image.width, height / image.height).translate_lu1900$(numberToDouble(x), numberToDouble(y))));
  ...
  Context2d$State.prototype.clone = function () {
    var tmp$;
    return this.copy_4jfro8$(this.transform.clone(), (tmp$ = this.clip) != null ? tmp$.clone() : null, this.path.clone());
  };
  ...
  Context2d$State.prototype.copy_4jfro8$ = function (transform, clip, path, lineScaleMode, lineWidth, lineCap, lineJoin, miterLimit, strokeStyle, fillStyle, font, verticalAlign, horizontalAlign, globalAlpha) {
  ...
  Context2d.prototype.fillStyle_mb1y7v$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.fillStyle_mb1y7v$', function (paint, callback) {
  ...
  Context2d.prototype.strokeStyle_mb1y7v$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.strokeStyle_mb1y7v$', function (paint, callback) {
  ...
  Context2d.prototype.font_yrt615$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.font_yrt615$', function (font, halign, valign, callback) {
    if (halign === void 0)
      halign = null;
    if (valign === void 0)
      valign = null;
  ...
  Context2d.prototype.fillStyle_2rievy$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.fillStyle_2rievy$', function (color, callback) {
  ...
  Context2d.prototype.keepApply_hqcxwp$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.keepApply_hqcxwp$', wrapFunction(function () {
    return function (callback) {
      this.save();
      try {
        callback(this);
  ...
  Context2d.prototype.keep_o14v8n$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.keep_o14v8n$', function (callback) {
    this.save();
    try {
      callback();
    }
  ...
  Context2d.prototype.keepTransform_o14v8n$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.keepTransform_o14v8n$', function (callback) {
  ...
  Context2d.prototype.save = function () {
    return this.stack_0.push_11rb$(this.state.clone());
  };
  Context2d.prototype.restore = function () {
    this.state = this.stack_0.pop();
  };
  Context2d.prototype.scale_z8e4lc$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.scale_z8e4lc$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
  ...
  Context2d.prototype.translate_z8e4lc$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.translate_z8e4lc$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (tx, ty) {
      return this.translate_lu1900$(numberToDouble(tx), numberToDouble(ty));
    };
  }));
  Context2d.prototype.rotate_3p81yu$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.rotate_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (angle) {
      return this.rotate_14dthe$(numberToDouble(angle));
    };
  }));
  Context2d.prototype.rotateDeg_3p81yu$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.rotateDeg_3p81yu$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
  ...
  Context2d.prototype.strokeRect_1ugm5o$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.strokeRect_1ugm5o$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (x, y, width, height) {
      this.strokeRect_6y0v78$(numberToDouble(x), numberToDouble(y), numberToDouble(width), numberToDouble(height));
    };
  }));
  Context2d.prototype.fillRect_1ugm5o$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.fillRect_1ugm5o$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (x, y, width, height) {
      this.fillRect_6y0v78$(numberToDouble(x), numberToDouble(y), numberToDouble(width), numberToDouble(height));
    };
  }));
  Context2d.prototype.fillRoundRect_9wz194$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.fillRoundRect_9wz194$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var roundRect = _.$$importsForInline$$.korma.com.soywiz.korma.geom.vector.roundRect_eslsqu$;
  ...
  Context2d.prototype.stroke_mb1y7v$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.stroke_mb1y7v$', function (paint, callback) {
    callback();
    this.stroke_i8h3xk$(paint);
  });
  Context2d.prototype.stroke_2rievy$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.stroke_2rievy$', wrapFunction(function () {
    ...
    switch (rasterizerMethod.name) {
      ...
      case 'X4':
        ...
        try {
          ...
          this.renderer.drawImage_dfapkx$(renderBi, 0, 0);
        }
        finally {
          t.setTo_15yvbs$(a, b, c, d, tx, ty);
        }
  ...
  Context2d.prototype.fillText_2w64eq$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.fillText_2w64eq$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (text, x, y) {
      this.renderText_a7koit$(text, numberToDouble(x), numberToDouble(y), true);
    };
  }));
  Context2d.prototype.strokeText_2w64eq$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.strokeText_2w64eq$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    return function (text, x, y) {
      this.renderText_a7koit$(text, numberToDouble(x), numberToDouble(y), false);
    };
  }));
  Context2d.prototype.fillText_j0r20$ = defineInlineFunction('korim.com.soywiz.korim.vector.Context2d.fillText_j0r20$', wrapFunction(function () {
    var numberToDouble = Kotlin.numberToDouble;
    var Unit = Kotlin.kotlin.Unit;
  ...
  Context2d.prototype.drawImage_dpo8os$ = function (image, x, y, width, height) {
    ...
    if (height === void 0)
      height = image.height;
    this.renderer.drawImage_dfapkx$(image, x, y, width, height, this.state.transform);
  };
  ...
  StyledShape.prototype.buildSvg_b7xfbk$ = function (svg) {
    var tmp$ = svg.nodes;
    var element = Xml_0.Companion.Tag_imnfz6$('path', plus_1(mapOf_0(to('d', toSvgPathString(this.path))), this.getSvgXmlAttributes_b7xfbk$(svg)), emptyList());
  ...
  FillShape.prototype.getSvgXmlAttributes_b7xfbk$ = function (svg) {
    return plus_1(StyledShape.prototype.getSvgXmlAttributes_b7xfbk$.call(this, svg), mapOf_0(to('fill', toSvg_1(this.paint, svg))));
  };
  ...
  PolylineShape.prototype.addBounds_w97n1m$ = function (bb) {
    ...
    var tmp$ = this.tempRect_0;
    var a = this.thickness - 1.0;
    var tmp$_0 = Math_0.max(a, 0.0);
    var a_0 = this.thickness - 1.0;
    tmp$.inflate_lu1900$(tmp$_0, Math_0.max(a_0, 0.0));
  ...
  PolylineShape.prototype.getSvgXmlAttributes_b7xfbk$ = function (svg) {
    return plus_1(StyledShape.prototype.getSvgXmlAttributes_b7xfbk$.call(this, svg), mapOf([to('stroke-width', this.thickness.toString()), to('stroke', toSvg_1(this.paint, svg))]));
  };
  ...
  function SVG_0(root, warningProcessor) {
    ...
    while (tmp$_0.hasNext()) {
      ...
      var tmp$_1;
      var tmp$_2;
      destination.add_11rb$((tmp$_1 = toDoubleOrNull(trim_0(Kotlin.isCharSequence(tmp$_2 = item) ? tmp$_2 : throwCCE()).toString())) != null ? tmp$_1 : 0.0);
    }
          ...
          while (tl.hasMore) {
            ...
            switch (cmd) {
              ...
              case 109:
                var x_2 = readNumber();
                var y_2 = readNumber();
                c.moveTo_lu1900$(c.lastX + numberToDouble(x_2), c.lastY + numberToDouble(y_2));
                while (isNextNumber()) {
                  var x_3 = readNumber();
                  var y_3 = readNumber();
              ...
              case 108:
                while (isNextNumber()) {
                  var x_4 = readNumber();
                  var y_4 = readNumber();
                  c.lineTo_lu1900$(c.lastX + numberToDouble(x_4), c.lastY + numberToDouble(y_4));
                }
              ...
              case 72:
                while (isNextNumber()) {
                  var x_5 = readNumber();
                  var y_5 = c.lastY;
                  c.lineTo_lu1900$(numberToDouble(x_5), numberToDouble(y_5));
                }
              ...
              case 104:
                while (isNextNumber()) {
                  var x_6 = readNumber();
                  c.lineTo_lu1900$(c.lastX + numberToDouble(x_6), c.lastY);
                }
              ...
              case 86:
                while (isNextNumber()) {
                  var y_6 = readNumber();
                  c.lineTo_lu1900$(numberToDouble(c.lastX), numberToDouble(y_6));
                }
              ...
              case 118:
                while (isNextNumber()) {
                  var y_7 = readNumber();
                  c.lineTo_lu1900$(c.lastX, c.lastY + numberToDouble(y_7));
                }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            if (util.OS.isJsNodeJs) {
              this.state_0 = 7;
              this.result_0 = await_0(Kotlin.isType(tmp$ = require('canvas').loadImage(this.$this.toNodeJsBuffer_0(this.local$bytes)), Promise) ? tmp$ : throwCCE(), this);
              if (this.result_0 === COROUTINE_SUSPENDED)
                return COROUTINE_SUSPENDED;
              continue;
            }
  ...
  function BrowserImage$loadImage$lambda(closure$jsUrl) {
    return function (c) {
      var tmp$;
      if (util.OS.isJsNodeJs) {
        (Kotlin.isType(tmp$ = require('canvas').loadImage(closure$jsUrl), Promise) ? tmp$ : throwCCE()).then(BrowserImage$loadImage$lambda$lambda(c), BrowserImage$loadImage$lambda$lambda_0(c));
      }
       else {
        var img = document.createElement('img');
  ...
  Kotlin.defineModule('korim', _);
  return _;
}));

//# sourceMappingURL=korim.js.map

(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'korinject'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'korinject'.");
    }
    root.korinject = factory(typeof korinject === 'undefined' ? {} : korinject, kotlin);
  }
  ...
  defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.getWith_84k75t$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
  ...
  defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.get_30y1fr$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
  ...
  defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.getOrNull_30y1fr$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT, continuation) {
  ...
  AsyncInjector.prototype.mapInstance_issdgt$ = defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.mapInstance_issdgt$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT, instance) {
      return this.mapInstance_b1ce0a$(getKClass(T_0), instance);
    };
  }));
  AsyncInjector.prototype.mapFactory_p9ghmn$ = defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.mapFactory_p9ghmn$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT, gen) {
      return this.mapFactory_mvlsy$(getKClass(T_0), gen);
    };
  }));
  AsyncInjector.prototype.mapSingleton_j3d0d8$ = defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.mapSingleton_j3d0d8$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT, gen) {
      return this.mapSingleton_siz2e9$(getKClass(T_0), gen);
    };
  }));
  AsyncInjector.prototype.mapPrototype_j3d0d8$ = defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.mapPrototype_j3d0d8$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    return function (T_0, isT, gen) {
  ...
  AsyncInjector.prototype.getSync_nw6hre$ = defineInlineFunction('korinject.com.soywiz.korinject.AsyncInjector.getSync_nw6hre$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
  ...
  Kotlin.defineModule('korinject', _);
  return _;
}));

//# sourceMappingURL=korinject.js.map
